/*
 * Lambda Transform Loan Repayments - Terraform Configuration
 * Transforms raw loan repayments CSV to silver Parquet
 */

locals {
  function_name = "transform-loan-repayments-${var.environment}"
...
resource "aws_iam_policy" "lambda_s3_policy" {
  ...
  description = "S3 permissions for loan repayments transformation Lambda"
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.raw_bucket_name}/loan_repayments/raw/*"
        ]
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.silver_bucket_name}/transformed/loan_repayments/*",
          "arn:aws:s3:::${var.silver_bucket_name}/_markers/*",
          "arn:aws:s3:::${var.silver_bucket_name}/error/loan_repayments/*"
        ]
      },
      {
        Sid    = "ListBuckets"
...
resource "aws_lambda_function" "transformer" {
  filename         = "${path.module}/../../../../src/lambda/lambda_transform_loan_repayments/dist/lambda_function.zip"
  function_name    = local.function_name
  role             = aws_iam_role.lambda_role.arn
  handler          = "lambda_function.lambda_handler"
  source_code_hash = filebase64sha256("${path.module}/../../../../src/lambda/lambda_transform_loan_repayments/dist/lambda_function.zip")
  runtime          = var.runtime
  timeout          = var.timeout
