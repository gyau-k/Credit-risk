...
locals {
  function_name = "loan-repayments-validator-${var.environment}"

  # Construct full paths for environment variables
  source_path = "${var.landing_bucket_name_loan_repayments}/${var.landing_prefix_loan_repayments}"
  raw_path    = "${var.processed_bucket_name_loan_repayments}/${var.raw_prefix_loan_repayments}"
  reject_path = "${var.processed_bucket_name_loan_repayments}/${var.reject_prefix_loan_repayments}"
...
data "archive_file" "lambda_zip" {
  type        = "zip"
  source_file = "${path.module}/../../../../src/lambda/lambda_loan_repayments/lambda_function.py"
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.landing_bucket_name_loan_repayments}/${var.landing_prefix_loan_repayments}*"
        ]
      },
      {
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.processed_bucket_name_loan_repayments}/${var.raw_prefix_loan_repayments}*",
          "arn:aws:s3:::${var.processed_bucket_name_loan_repayments}/${var.reject_prefix_loan_repayments}*"
        ]
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.landing_bucket_name_loan_repayments}",
          "arn:aws:s3:::${var.processed_bucket_name_loan_repayments}"
        ]
      }
    ]
  })
...
# Lambda Function
resource "aws_lambda_function" "csv_validator_loan_repayments" {
...
resource "aws_cloudwatch_metric_alarm" "lambda_errors" {
  ...
  dimensions = {
    FunctionName = aws_lambda_function.csv_validator_loan_repayments.function_name
  }
