...
locals {
  function_name = "loan-application-validator-${var.environment}"

  # Construct full paths for environment variables
  source_path = "${var.landing_bucket_name_loan_application}/${var.landing_prefix_loan_application}"
  raw_path    = "${var.processed_bucket_name_loan_application}/${var.raw_prefix_loan_application}"
  reject_path = "${var.processed_bucket_name_loan_application}/${var.reject_prefix_loan_application}"
...
data "archive_file" "lambda_zip" {
  type        = "zip"
  source_file = "${path.module}/../../../../src/lambda/lambda_loan_applications/lambda_function.py"
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.landing_bucket_name_loan_application}/${var.landing_prefix_loan_application}*"
        ]
      },
      {
      ...
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.processed_bucket_name_loan_application}/${var.raw_prefix_loan_application}*",
          "arn:aws:s3:::${var.processed_bucket_name_loan_application}/${var.reject_prefix_loan_application}*"
        ]
      },
      {
        ...
        Resource = [
          "arn:aws:s3:::${var.landing_bucket_name_loan_application}",
          "arn:aws:s3:::${var.processed_bucket_name_loan_application}"
        ]
      }
    ]
  })
...
# Lambda Function
resource "aws_lambda_function" "csv_validator_loan_application" {
...
resource "aws_cloudwatch_metric_alarm" "lambda_errors" {
  ...
  dimensions = {
    FunctionName = aws_lambda_function.csv_validator_loan_application.function_name
  }
